    ...
    public partial class Form1 : Form
    {
       private int rI, rJ;
        ...
        public Form1()
        {
            ...
            snake[0].Image = Image.FromFile(@"C:\Users\Человек\source\repos\CSharpProjects-master\Snake\Snake\snake2.jpg");
            this.Controls.Add(snake[0]);
            fruit = new PictureBox();
            fruit.BackColor = Color.Yellow;
            fruit.Image = Image.FromFile(@"C:\Users\Человек\source\repos\CSharpProjects-master\Snake\Snake\food.jpg");
        ...
        private void _checkBorders()
        {
            if (snake[0].Location.X < 0)
            {
                ...
                labelScore.Text = "Score: " + score;
                 dirX = 1; 
                timer.Interval = 200000;MessageBox.Show("Вы проиграли"); Close();
            ...
            if (snake[0].Location.X > _height)
            {
                ...
                score = 0;
                labelScore.Text = "Score: " + score;
                dirX = -1; timer.Interval = 200000; MessageBox.Show("Вы проиграли"); Close();   
            }
        ...
        private void _eatFruit()
        {
            if(snake[0].Location.X == rI && snake[0].Location.Y == rJ)
            {
                ...
                snake[score].Image = Image.FromFile(@"C:\Users\Человек\source\repos\CSharpProjects-master\Snake\Snake\snake1.jpg");
                this.Controls.Add(snake[score]);
  
                timer.Interval = 300 - score;
                labelScore.Text = "Score: " + score;
                _generateFruit();
            }
        }
